...
```
Error running 'main': 
Cannot run program "C:\Python Save Location\pythonProject1\venv\Scripts\python.exe" (in directory "C:\Python Save Location\pythonProject1"): 
CreateProcess error=2, 系統找不到指定的檔案。
```
> ## VS code
```
Traceback (most recent call last):
  File "c:\Users\harry\OneDrive\桌面\-#Program-\Python\Crawler Video\Module\AV.py", line 1, in <module>
    from Module import net_fn
