...
/****************************/
const char* ACCOUNT[ACCOUNT_NUMBER]= {"4080E009"};
const char* PASSWORD[ACCOUNT_NUMBER]= {"yimel043"};
//請填入estar.tw申請到的iot帳密與代碼
const char* SENDID[ACCOUNT_NUMBER]= {"10001231"};
...
/***********************************/
      ...
      const int inputpin[MULTI][ACCOUNT_NUMBER]= {{5}};    //d1-->5　
  #endif  //#if MULTI>=2
  #endif  //#ifdef ESP12
  #ifdef WF8266
  #if MULTI>=2
